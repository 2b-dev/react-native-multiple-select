...
export default class MultiSelect extends Component {
  ...
  _getRow = item => {
    ...
    return (
      ...
      >
        <View>
          <View style={[{ flexDirection: 'row', alignItems: 'center', paddingLeft: 20, paddingRight: 20}, this._itemSelected(item) ? {backgroundColor: '#FFBB3D'}:{}]}>
            <Text
              style={[
                {
                  flex: 1,
  ...
  render() {
    ...
    return (
      ...
      >
        {selector ? (
          <View style={[styles.selectorView(fixedHeight), {borderWidth:2, borderColor: '#192c3f', borderRadius: 3,}]}>
            <View style={[styles.inputGroup,{borderWidth:2, borderColor: '#192c3f', borderRadius: 3, marginTop:3, marginLeft:3, marginRight: 3,}]}>              
              <TextInput
                ...
                style={[searchInputStyle, { flex: 1, fontSize: 16, }]}
                value={searchTerm}                
              />
              <Icon
                name="magnify"
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    name="menu-down"
                    style={[                      
                      { paddingLeft: 15, paddingRight: 15, fontSize: 30, color: '#192c3f'}
                    ]}
                  />
                </TouchableOpacity>
              )}
                ...
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      ...
                      style={{fontSize: 30, color: '#192c3f'}}
                    />
                  </View>
                </TouchableWithoutFeedback>
              </View>
